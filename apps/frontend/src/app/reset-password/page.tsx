...
// useSearchParams() opts the tree into client-side rendering, so the reader has to
// sit behind a Suspense boundary or the route fails to prerender at build time.
